...
htmlhelp_basename = 'bubble_plotdoc'
...
latex_documents = [
    (master_doc, 'bubble_plot.tex', 'bubble_plot Documentation', 'Zar',
     'manual'),
]
...
man_pages = [(master_doc, 'bubbleplot', 'bubble_plot Documentation', [author],
              1)]
...
texinfo_documents = [
    (master_doc, 'bubble_plot', 'bubble_plot Documentation', author,
     'bubble_plot', 'One line description of project.', 'Miscellaneous'),
]
